...
def sample_fast(n, prior, tree_depth, max_num_variables, file=None):
...
def sample_trees_fast(n, prior, tree_depth, max_num_variables):
    results = []

    # Create a tqdm progress bar
    for _ in tqdm(range(n), desc="Processing", unit="iteration"):
        result = _sample_tree_iter_fast(prior, tree_depth, max_num_variables)
